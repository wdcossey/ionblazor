...
public partial class IonDateTime : IonComponent
{
    ...
    private readonly DotNetObjectReference<IonicEventCallback<JsonObject?>>? _ionBlurReference;
    private readonly DotNetObjectReference<IonicEventCallback<JsonObject?>>? _ionCancelReference;
    private readonly DotNetObjectReference<IonicEventCallback<JsonObject?>>? _ionChangeReference;
    private readonly DotNetObjectReference<IonicEventCallback<JsonObject?>>? _ionFocusReference;
    ...
    /// </summary>
    [Parameter] public string? DayValues { get; set; }
    ...
    /// </summary>
    [Parameter] public int FirstDayOfWeek { get; set; } = 0;
    ...
    /// </summary>
    [Parameter] public string? HourCycle { get; set; } = IonDateTimeHourCycle.Default;
    ...
    /// an array of numbers, or a string of comma separated numbers.
    /// </summary>
    [Parameter] public string? HourValues { get; set; }
    ...
    /// </summary>
    [Parameter] public Func<string?, bool>? IsDateEnabled { get; set; }
    ...
    /// </summary>
    [Parameter] public string? MinuteValues { get; set; }
    ...
    /// </summary>
    [Parameter] public string? MonthValues { get; set; }
    ...
    /// </summary>
    [Parameter] public bool PreferWheel { get; set; }
    ...
    /// </summary>
    [Parameter] public string Presentation { get; set; } = IonDateTimePresentation.DateTime;
    ...
    /// </summary>
    [Parameter] public bool ShowDefaultTimeLabel { get; set; } = true;
    ...
    /// </summary>
    [Parameter] public bool ShowDefaultTitle { get; set; }
    
    /// <summary>
    /// If cover, the ion-datetime will expand to cover the full width of its container.
    /// If fixed, the ion-datetime will have a fixed width.
    /// </summary>
    [Parameter] public string Size { get; set; } = IonDateTimeSize.Fixed;
    ...
    /// </summary>
    [Parameter] public string? YearValues { get; set; }
    ...
    /// </summary>
    [Parameter] public EventCallback<IonDateTimeChangeEventArgs> IonChange { get; set; }
    ...
    public IonDateTime()
    {
        ...
        _ionCancelReference = DotNetObjectReference.Create<IonicEventCallback<JsonObject?>>(new (async args =>
        {
