...
public partial class IonSegmentButton: IonControl
{
    ...
    /// </summary>
    [Parameter] public string? Layout { get; set; } = IonSegmentButtonLayout.IconTop;
    ...
    /// </summary>
    [Parameter] public string Type { get; set; } = IonSegmentButtonType.Button;
