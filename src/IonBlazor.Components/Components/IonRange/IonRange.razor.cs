...
public sealed partial class IonRange : IonContentComponent, IIonColorComponent, IIonModeComponent
{
    ...
    public override async ValueTask DisposeAsync()
    {
        ...
        _ionKnobMoveEndReference.Dispose();
        _ionKnobMoveStartReference.Dispose();
        _pinFormatterReference.Dispose();
...
public sealed record RangeChangeEventArgs : IRangeChangeEventArgs
{
    /// <summary>
