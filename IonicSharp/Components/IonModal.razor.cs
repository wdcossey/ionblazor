...
public partial class IonModal : IonComponent
{
    ...
    /// </summary>
    [Parameter] public double BackdropBreakpoint { get; set; } = 0.0d;
    ...
    /// </summary>
    [Parameter] public string? HandleBehavior { get; set; } = IonModalHandleBehavior.None;
    ...
    /// </summary>
    [Parameter] public bool? KeepContentsMounted { get; set; } = false;
    
    /// <summary>
    /// If <b>true</b>, the keyboard will be automatically dismissed when the overlay is presented.
    /// </summary>
    [Parameter] public bool KeyboardClose { get; set; } = true;
    ...
    /// </summary>
    [Parameter] public EventCallback IonBreakpointDidChange { get; set; }
    
    /// <summary>
    /// Emitted after the modal has dismissed.
    /// </summary>
    [Parameter] public EventCallback IonModalDidDismiss { get; set; }
    
    /// <summary>
    /// Emitted after the modal has presented.
    /// </summary>
    [Parameter] public EventCallback IonModalDidPresent { get; set; }
    
    /// <summary>
    /// Emitted before the modal has dismissed.
    /// </summary>
    [Parameter] public EventCallback IonModalWillDismiss { get; set; }
    
    /// <summary>
    /// Emitted before the modal has presented.
    /// </summary>
    [Parameter] public EventCallback IonModalWillPresent { get; set; }
    
    /// <summary>
    /// Emitted before the modal has dismissed. Shorthand for ionModalWillDismiss.
    /// </summary>
    [Parameter] public EventCallback<IonModalWillDismissEventArgs> WillDismiss { get; set; }
            ...
            /*
{
  ...
  "detail": {
    "role": "backdrop"
            ...
            await WillDismiss.InvokeAsync(new IonModalWillDismissEventArgs() { Sender = this, Data = data, Role = role});
        }));
