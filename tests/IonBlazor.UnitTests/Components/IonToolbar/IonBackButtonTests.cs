...
public class IonBackButtonTests : IonTestContext
{
    // ---------------------------------------------------------------------------
    // Render tests
    // ---------------------------------------------------------------------------
    ...
    [Fact]
    public async Task IonBackButtonRendersCorrectly()
    {
        var cut = Render<IonBackButton>();
    ...
    public async Task WithMode_RendersCorrectly(string mode)
    {
        ...
        var cut = Render<IonBackButton>(parameters => parameters
            .Add(p => p.Mode, mode));
    ...
    [Fact]
    public async Task WithDefaultHref_RendersCorrectly()
    {
        var cut = Render<IonBackButton>(parameters => parameters
            .Add(p => p.DefaultHref, "/home"));

        await Verify(cut.Markup);
    }

    [Fact]
    public async Task WithText_RendersCorrectly()
    {
        var cut = Render<IonBackButton>(parameters => parameters
            .Add(p => p.Text, "Back"));
