...
public partial class IonTextarea : IonComponent, IIonColorComponent, IIonModeComponent, IIonContentComponent
{
...
public class IonTextareaInputEventArgs : EventArgs, IIonInputEventArgs
{
#if NET7_0_OR_GREATER
    public required IonTextarea Sender { get; init; } = null!;
#else
    public IonTextarea Sender { get; init; } = null!;
#endif
...
public class IonTextareaChangeEventArgs : EventArgs, IIonInputEventArgs
{
#if NET7_0_OR_GREATER
    public required IonTextarea Sender { get; init; } = null!;
#else
