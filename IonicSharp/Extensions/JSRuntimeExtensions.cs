...
{
    //await JsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/IonicSharp/Components/IonModal.razor.js");
    internal static Task<IJSObjectReference> ImportAsync(this IJSRuntime jsRuntime, string fileName) => 
        jsRuntime.InvokeAsync<IJSObjectReference>("import", $"./_content/IonicSharp/{fileName}.js").AsTask();
