...
public class IonMenuButtonTests : IonTestContext
{
    // ---------------------------------------------------------------------------
    // Render tests
    // ---------------------------------------------------------------------------
    ...
    [Fact]
    public async Task IonMenuButtonRendersCorrectly()
    {
        var cut = Render<IonMenuButton>();
    ...
    public async Task WithMode_RendersCorrectly(string mode)
    {
        ...
        var cut = Render<IonMenuButton>(parameters => parameters
            .Add(p => p.Mode, mode));
