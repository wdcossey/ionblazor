...
public partial class IonFabButton : IonComponent, IIonModeComponent, IIonContentComponent, IIonColorComponent
{
    ...
    /// </summary>
    [Parameter]
    public string? RouterDirection { get; set; } = IonRouterDirection.Forward;
