    ...
    where TButton: class, IPickerButton
{
    ...
    public async Task DismissAsync(object[]? data = null, string? role = null) => 
        await JsRuntime.InvokeVoidAsync("IonBlazor.IonPicker.dismiss", _self, data, role);
    
    /// <summary>
    /// Get the column that matches the specified name.
    /// </summary>
    public async Task<object> GetColumnAsync(string name) => 
        await JsRuntime.InvokeAsync<JsonObject>("IonBlazor.IonPicker.getColumn", _self, name);
    
    /// <summary>
    /// Present the picker overlay after it has been created.
    /// </summary>
    public async Task PresentAsync() => 
        await JsRuntime.InvokeVoidAsync("IonBlazor.IonPicker.present", _self);
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        await JsRuntime.InvokeVoidAsync("IonBlazor.IonPicker.withColumns", _self, columns);
        await JsRuntime.InvokeVoidAsync("IonBlazor.IonPicker.withButtons", _self, buttons, _buttonHandlerReference);
    }
}
