...
public partial class IonItem : IonComponent
{
    ...
    /// </summary>
    [Parameter] public bool Button { get; set; } = false;
    ...
    /// </summary>
    [Parameter] public string DetailIcon { get; set; } = "chevron-forward";
    ...
    /// </summary>
    [Parameter] public string? Fill { get; set; } = IonItemFill.Default;
    ...
    /// </summary>
    [Parameter] public string? Lines { get; set; } = IonItemLines.Default;
    ...
    /// The shape of the item. If <see cref="IonItemShape.Round"/> it will have increased border radius.
    /// </summary>
    [Parameter] public string? Type { get; set; } = IonItemType.Default;
}
